...
*By [Julian Chultarsky](mailto:jchultarsky@physna.com), June 2022*
...
The utility is currently in alpha and it is designed for **internal** use at Physna. Use by third party requires approval
by your Physna representative.

## Dependencies

This project depends on the api-client-v2 project, which is autogenerated
from the OpenAPI specs for the API. To build, clone the required project
and add dependency in your Cargo.toml.

## Change Log

The latest supported version is 1.3.4.
