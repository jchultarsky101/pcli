...
#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ListOfImageClassifiers {
    #[serde(rename = "classifiers")]
    pub classifiers: Vec<ImageClassifier>,
}
...
impl From<Vec<ImageClassifier>> for ListOfImageClassifiers {
    fn from(classifiers: Vec<ImageClassifier>) -> Self {
        ListOfImageClassifiers::new(classifiers)
    }
}

impl ToJson for ListOfImageClassifiers {
    fn to_json(&self, pretty: bool) -> Result<String, serde_json::Error> {
        if pretty {
            serde_json::to_string_pretty(self)
        } else {
...
#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ImageClassificationScore {
    #[serde(rename = "uuid")]
    pub model_uuid: Uuid,
    #[serde(rename = "name")]
    pub model_name: String,
    #[serde(rename = "classificationScore")]
    pub score: f64,
}

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ListOfClassificationScores {
    #[serde(rename = "models")]
    pub scores: Vec<ImageClassificationScore>,
}

impl ToJson for ListOfClassificationScores {
    fn to_json(&self, pretty: bool) -> Result<String, serde_json::Error> {
        if pretty {
            serde_json::to_string_pretty(self)
        } else {
